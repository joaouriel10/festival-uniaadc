  ...
  return (
    <div className="relative mx-auto max-w-6xl p-40">
      ...
      <div className="mx-auto mb-8 grid max-w-4xl grid-cols-1 place-items-center gap-6 md:grid-cols-3">
        <Card className="h-full max-h-[95%] border-0 bg-gradient-to-br from-gray-300 to-gray-500 shadow-2xl">
        ...
        <Card className="border-0 bg-gradient-to-br from-yellow-400 to-yellow-600 shadow-2xl">
          <CardContent className="p-8 text-center text-white">
            <div className="mb-4">
              ...
              <Badge className="mt-2 bg-white/20 text-white">🥇 CAMPEÃO</Badge>
            </div>
