/** biome-ignore-all lint/performance/noNamespaceImport: silence */
/** biome-ignore-all lint/suspicious/noArrayIndexKey: silence */
/** biome-ignore-all lint/style/noNestedTernary: silence */
'use client';
